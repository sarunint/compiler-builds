 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function jitExpression(def,context,sourceUrl,preStatements){return jitStatements(sourceUrl,preStatements.concat([new DeclareVarStmt("$def",def,void 0,[exports.StmtModifier.Exported])]),new R3JitReflector(context),!1).$def}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
